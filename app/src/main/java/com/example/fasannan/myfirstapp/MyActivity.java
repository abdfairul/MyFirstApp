...
public class MyActivity extends Activity {
    ...
    public final static String EXTRA_MESSAGE = "com.example.fasannan.myfirstapp.MESSAGE";
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.myactivity_actions, menu);
    ...
    public void sendMessage(View view) {
        ...
        // find edittext element by ID
        EditText editText = (EditText) findViewById(R.id.edit_message);
        String message = editText.getText().toString();
        // extra is a key-value pair data type (keyname, value)
